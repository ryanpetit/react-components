...
function KanbanOverlay({ children, className }: KanbanOverlayProps) {
  ...
  const [clonedElement, setClonedElement] = React.useState<string | null>(null)
  ...
  }, [activeId, findContainer, isColumn])
  ...
  const content = React.useMemo(() => {
    ...
    if (!children && clonedElement) {
      return <div dangerouslySetInnerHTML={{ __html: clonedElement }} />
    }
    return children
  }, [activeId, children, isColumn, clonedElement])
